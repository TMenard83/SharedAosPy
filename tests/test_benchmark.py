...
from aospy import benchmark as bench
from aospy import db, repository, seed
from aospy.cli import main as cli_main
from aospy.combat import CombatModifiers, expected_unit_damage
from aospy.report import format_benchmark, format_benchmark_table, format_duel_detail
from aospy.simulation import SideOptions
...
def test_unit_duel_charge_bonus(con):
    libs, clan = _pair(con)
    ...
    assert with_charge.raw_a_to_b > no_charge.raw_a_to_b
