...
from aospy.report import format_report
from aospy.simulation import SideOptions, simulate_battle
...
def test_charge_increases_damage(con):
    a_id, b_id = _comp_ids(con)
    ...
    assert with_charge.a_to_b.best_target_total > no_charge.a_to_b.best_target_total
