...
def test_charge_ability_bonus_cumulative_with_universal_attack_bonus():
    # Charge (+1 Damage) en plus du bonus universel +1 attaque en mêlée déjà codé.
    weapon = Weapon(name="w", kind="melee", attacks=2, hit=4, wound=4, damage=1,
    ...
    # chargé : (2+1 attaques)*5=15 atk * 1/2 * 1/2 * dmg (1+1)=2 = 7.5
