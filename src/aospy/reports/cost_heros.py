...
story.append(Paragraph(
    ...
    "facteurs (armée, armement, type…) dans deux régressions distinctes. Un essai des deux régressions "
...
story.append(Paragraph(
    ...
    "(toutes autres caractéristiques égales) ; « Héros × dégât vs aucune save » et « Héros × PV totaux » "
    "modulent, en plus, le prix des dégâts et de la durabilité spécifiquement pour les héros.",
    section_note,
))
